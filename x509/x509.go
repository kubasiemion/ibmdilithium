...
func marshalPublicKey(pub interface{}) (publicKeyBytes []byte, publicKeyAlgorithm pkix.AlgorithmIdentifier, err error) {
	...
	case *ibmdilithium.DILPublicKey:
...
var signatureAlgorithmDetails = []struct {
	...
	{SHA256WithDilithium, "Dilithium-SHAKE256", ibmdilithium.SHAKE256WithDilithiumOID, DilithiumR3, crypto.SHA256},
}
...
func getPublicKeyAlgorithmFromOID(oid asn1.ObjectIdentifier) PublicKeyAlgorithm {
	...
	case oid.Equal(oidPublicKeyEd25519):
		return Ed25519
	case oid.Equal(ibmdilithium.OIDDilithiumHigh):
		return DilithiumR3
	}
...
func checkSignature(algo SignatureAlgorithm, signed, signature []byte, publicKey crypto.PublicKey) (err error) {
	...
	case ed25519.PublicKey:
		...
		return
	case *ibmdilithium.DILPublicKey:
		if pubKeyAlgo != DilithiumR3 {
			return errors.New("Dilitium signing algo mismatch")
		}
		return pub.Verify(signed, signature)
	}
	return ErrUnsupportedAlgorithm
}
...
func signingParamsForPublicKey(pub interface{}, requestedSigAlgo SignatureAlgorithm) (hashFunc crypto.Hash, sigAlgo pkix.AlgorithmIdentifier, err error) {
	...
	case *ibmdilithium.DILPublicKey:
		pubType = DilithiumR3
		hashFunc = crypto.SHA256
		sigAlgo.Algorithm = ibmdilithium.SHAKE256WithDilithiumOID
...
// will be generated from the hash of the public key. HACKED
